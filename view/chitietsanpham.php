...
<div class="container-fluid py-5">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 pb-5">
            ...
            <form action="index.php?act=add_to_cart&idsp=<?= $id ?>" method="post">
                <input type="hidden" name="id" value="<?= $id ?>">
                <input type="hidden" name="img" value="<?= $img ?>">
                <input type="hidden" name="name" value="<?= $name ?>">
                <input type="hidden" name="price" value="<?= $price ?>">
                <input type="hidden" name="soluongg" value="<?= $soluong1 ?>">
                <div class="d-flex mb-3">
                ...
                <div class="d-flex mb-4">
                    ...
                    ?>
                        <div class=" custom-control custom-radio custom-control-inline">
                            ...
                            <label class="custom-control-label" for="color-<?php echo $i ?>"><?= $key['color'] ?></label>
                        </div>
                    <?php
                        $i++;
                    endforeach ?><br>
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <input type="number" min="1" max="" name="soluongg" id="" value="<?= $soluong1 ?>">
